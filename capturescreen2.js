...
function writeScreenshot(data, name) {
  name = name || 'ss.png';
  var screenshotPath = 'x:\\partofspeech\\screens\\';
...
if (browsername == "firefox") {
	...
	Client.controlFlow().on('uncaughtException', function(e) {
		console.error('**** ERROR ***** \n ' + e);
		fs.writeFile('x:\\partofspeech\\screens\\'+filetosave + '-' + browsername + '-error.txt', e, function(err) {  if(err) { return console.log(err); } });
	});
